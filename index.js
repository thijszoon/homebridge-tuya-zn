...
const SimpleFloorHeaterAccessory = require('./lib/SimpleFloorHeaterAccessory');
...
const PLUGIN_NAME = 'homebridge-tuya-lan-zn';
...
const CLASS_DEF = {
    ...
    simplefloorheater: SimpleFloorHeaterAccessory,
